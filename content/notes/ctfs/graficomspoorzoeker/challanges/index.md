...
# draft : true
### Used for ordering your content in lists. Lower weight gets higher?height=50px) precedence. So content with lower weight will come first.
### 0 does nothing !
weight : 0
...
![DarkByte](images/4.png?height=250px)
