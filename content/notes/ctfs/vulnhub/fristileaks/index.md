...
date : 2020-03-10T17:25:28+01:00
...
{{%attachments title="Related files" style="grey" pattern=".*(tcp.nmap)" /%}}
...
{{%attachments title="Related files" style="grey" pattern=".*(p_shell)" /%}}
...
{{%attachments title="Related files" style="grey" pattern=".*(r_s.py)" /%}}
